...
This project helps you to remove services/containers/networks/volumes by given filter after specified delay.
...
1. See containers/services/networks/volumes deleted after 10s:
        ...
        2018/01/15 18:38:52 Removed 0 service(s), 1 container(s), 0 network(s), 0 volume(s)
